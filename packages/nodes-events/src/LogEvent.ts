import { BuiltInSlotType, ITextWidget, LActionOptions, LGraphNode, LiteGraph, OptionalSlots, PropertyLayout, SlotLayout, Vector2, hasCircularReference, isJson, isObject } from "@litegraph-ts/core"
